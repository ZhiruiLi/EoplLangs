module MutablePairs.ParserSuite
( tests
) where
...
testParsePair = TestList
  [ testEq "Parse new pair expression"
           (NewPairExpr (constNum 1) (constNum 2))
           "pair(1, 2)"
  , testEq "Parse get left expression"
           (GetLeftExpr (NewPairExpr (constNum 3) (constNum 4)))
           "left(pair(1, 2))"
  , testEq "Parse set right expression"
           (SetRightExpr (NewPairExpr (constNum 5) (constNum 6)) (constNum 7))
           "setright(pair(5, 6), 7)"
  ]
